...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        await message.channel.send(stripIndents`
			**Elija un caballo para apostar:** _(Escriba el número)_
        ...
        if (!messages.size) return message.channel.send('Lo siento, ¡no puedo tener una carrera sin apuestas!');
        ...
        return message.channel.send(win ? `¡Buen trabajo! ¡Tu caballo ganó!` : '¡Mejor suerte la próxima vez!', { files: [leaderboard] });
