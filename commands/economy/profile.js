...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        if (bg === null) bg = 'https://media.discordapp.net/attachments/853673164114493452/856698065280434246/blank.png'
        ...
        try {
            async function createCanvas() {
                ...
                return new Canvas(600, 500)
                    ...
                    .addText(`${name} Perfil Card`, 190, 105)
                    .addText('Peces', 445, 140)
                    .addText('', 530, 140)
                    ...
                    .addText(`Acerca de ${user.user.username}`, 160, 182)
                    .setTextFont('30px Impact')
                    .addText('Nivel', 190, 140)
                    .addText('Rango', 300, 140)
                    .setTextFont('23px Impact')
                    .addText('Trabajos', 31, 260)
                    .addText('Begs', 31, 315)
                    .addText('Juegos', 31, 370)
                    .addText('', 97, 260)
                    .addText('', 85, 315)
                    .addText('', 100, 370)
          ...
          const attachment = new MessageAttachment(await createCanvas(), 'profile.png')
            ...
            console.log(e)
            return message.channel.send(`Oh no, ocurrió un error :( \`${e.message}\` inténtelo de nuevo más tarde.`);
        }
    }
}